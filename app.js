...
app.post('/login',function(req,res){
  ...
  if(
    ...
    illegalCharacters.test(username) ||
    illegalCharacters.test(password)
  ) {
    res.end("Invalid character has been entered");
  }
  //If the program reaches this point all inputs have been validated



  var passSql = 'SELECT password from users WHERE username = ' + mysql.escape(username);
  passSql = sanitizeHtml(passSql);
